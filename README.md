...
This is an FTP client for Node.js. It supports explicit and implicit FTPS over TLS, Passive Mode over IPv6, has a Promise-based API, and offers methods to operate on whole directories.
...
- `secure (boolean|"implicit")` FTPS over TLS, `true` for explicit FTPS, `"implicit"` for implict FTPS, default: false
